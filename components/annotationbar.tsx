...
import { AiOutlineDoubleLeft, AiOutlineDoubleRight, AiOutlineRightCircle, AiOutlineLeftCircle } from "react-icons/ai"
...
export default function AnnotationBar({ cardsInput }: AnnotationBarProps) {
	...
	return (
		<div className="flex items-center">
			...
			<button className="flex items-center text-4xl" onClick={onSwipe}>{!swiped ? <AiOutlineLeftCircle /> : <AiOutlineRightCircle />}</button>
		</div>
	)
}